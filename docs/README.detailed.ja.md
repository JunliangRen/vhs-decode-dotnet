...
Exact/IPP-fast matrix は各 cell と worker setting 間で deterministic でした。focused
storage 5 tests は native、AVX 無効、all hardware Intrinsics 無効の各 mode で成功し、
standard xUnit v3 suite は 1,613 tests を discover、1,610 passed、expected
environment-dependent skip は 3 でした。
