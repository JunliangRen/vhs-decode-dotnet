...
一套 hash，全部 1463 项标准 xUnit v3 测试通过。
...
dotnet test --solution VHSDecodeDotNet.slnx -c Release --no-build --no-restore --minimum-expected-tests 1463
...
`dotnet test` 和 Visual Studio Test Explorer 暴露 **1,463** 个可独立发现的测试。
