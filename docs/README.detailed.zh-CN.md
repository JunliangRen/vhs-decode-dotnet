...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 默认（5） | 15.207 s | 16.780 s | 7.533 s / 2.019x / 50.46% | 7.725 s / 2.172x / 53.96% | 5.320 s / 2.858x / 65.01% | 5.171 s / 3.245x / 69.19% |
...
`c92af1dfd0f96cd7f2d49f3219fb428d0f4e0865` 上完成审计。合并后的 main
`38b7d32` 把 20 个 .NET 单元格各重测三次；Python 两列沿用此前审计数据。固定夹具
