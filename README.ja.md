...
- Visual Studio 2026 の `.slnx` には **1,438** 件の標準 xUnit v3 test があり、
...
2026-08-12 の固定 Python reference 30 run を保持し、main `af2dfe5` を基にした
Phase 22 candidate で 2026-08-13 に .NET の全 60 measurement を更新しました。
