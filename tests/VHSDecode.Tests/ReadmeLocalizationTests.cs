...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "17.680 s | 20.173 s | 4.096 s | 4.316x | 4.618 s | 4.369x | 3.604 s | 4.906x | 3.392 s | 5.948x",
            "18.995 s | 21.062 s | 11.613 s | 1.636x | 13.183 s | 1.598x | 8.407 s | 2.259x | 9.340 s | 2.255x",
            "17.599 s | 19.493 s | 4.307 s | 4.086x | 4.805 s | 4.057x | 3.525 s | 4.993x | 3.203 s | 6.087x",
            "17.182 s | 19.727 s | 3.240 s | 5.303x | 3.764 s | 5.241x | 3.142 s | 5.468x | 2.830 s | 6.972x",
            "17.594 s | 19.583 s | 2.730 s | 6.445x | 3.168 s | 6.181x | 2.667 s | 6.598x | 2.327 s | 8.416x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "17.680 s | 20.173 s | 4.096 s | 4.316x | 76.83% | 4.618 s | 4.369x | 77.11% | 3.604 s | 4.906x | 79.62% | 3.392 s | 5.948x | 83.19%",
            "18.995 s | 21.062 s | 11.613 s | 1.636x | 38.86% | 13.183 s | 1.598x | 37.41% | 8.407 s | 2.259x | 55.74% | 9.340 s | 2.255x | 55.66%",
            "17.599 s | 19.493 s | 4.307 s | 4.086x | 75.52% | 4.805 s | 4.057x | 75.35% | 3.525 s | 4.993x | 79.97% | 3.203 s | 6.087x | 83.57%",
            "17.182 s | 19.727 s | 3.240 s | 5.303x | 81.14% | 3.764 s | 5.241x | 80.92% | 3.142 s | 5.468x | 81.71% | 2.830 s | 6.972x | 85.66%",
            "17.594 s | 19.583 s | 2.730 s | 6.445x | 84.48% | 3.168 s | 6.181x | 83.82% | 2.667 s | 6.598x | 84.84% | 2.327 s | 8.416x | 88.12%"
        ];
