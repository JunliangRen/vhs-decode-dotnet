...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.267 s | 3.564x | 4.690 s | 3.578x | 3.608 s | 4.215x | 3.393 s | 4.946x",
            "17.694 s | 19.414 s | 9.732 s | 1.818x | 11.640 s | 1.668x | 7.089 s | 2.496x | 7.947 s | 2.443x",
            "15.719 s | 17.801 s | 4.167 s | 3.772x | 4.648 s | 3.830x | 3.607 s | 4.358x | 3.388 s | 5.254x",
            "16.037 s | 18.266 s | 3.274 s | 4.899x | 4.096 s | 4.459x | 3.069 s | 5.225x | 2.732 s | 6.686x",
            "16.405 s | 18.395 s | 2.919 s | 5.620x | 3.765 s | 4.886x | 2.667 s | 6.150x | 2.327 s | 7.905x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.267 s | 3.564x | 71.94% | 4.690 s | 3.578x | 72.05% | 3.608 s | 4.215x | 76.28% | 3.393 s | 4.946x | 79.78%",
            "17.694 s | 19.414 s | 9.732 s | 1.818x | 45.00% | 11.640 s | 1.668x | 40.05% | 7.089 s | 2.496x | 59.93% | 7.947 s | 2.443x | 59.07%",
            "15.719 s | 17.801 s | 4.167 s | 3.772x | 73.49% | 4.648 s | 3.830x | 73.89% | 3.607 s | 4.358x | 77.05% | 3.388 s | 5.254x | 80.97%",
            "16.037 s | 18.266 s | 3.274 s | 4.899x | 79.59% | 4.096 s | 4.459x | 77.57% | 3.069 s | 5.225x | 80.86% | 2.732 s | 6.686x | 85.04%",
            "16.405 s | 18.395 s | 2.919 s | 5.620x | 82.21% | 3.765 s | 4.886x | 79.53% | 2.667 s | 6.150x | 83.74% | 2.327 s | 7.905x | 87.35%"
        ];
