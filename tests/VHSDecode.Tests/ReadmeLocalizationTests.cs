...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.454 s | 3.414x | 4.954 s | 3.387x | 3.619 s | 4.202x | 3.463 s | 4.845x",
            "17.694 s | 19.414 s | 9.931 s | 1.782x | 11.898 s | 1.632x | 7.198 s | 2.458x | 7.989 s | 2.430x",
            "15.719 s | 17.801 s | 4.499 s | 3.494x | 4.893 s | 3.638x | 3.612 s | 4.352x | 3.445 s | 5.167x",
            "16.037 s | 18.266 s | 3.727 s | 4.303x | 4.341 s | 4.207x | 3.036 s | 5.282x | 2.762 s | 6.612x",
            "16.405 s | 18.395 s | 3.045 s | 5.387x | 3.828 s | 4.805x | 2.751 s | 5.964x | 2.378 s | 7.735x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.454 s | 3.414x | 70.71% | 4.954 s | 3.387x | 70.48% | 3.619 s | 4.202x | 76.20% | 3.463 s | 4.845x | 79.36%",
            "17.694 s | 19.414 s | 9.931 s | 1.782x | 43.87% | 11.898 s | 1.632x | 38.71% | 7.198 s | 2.458x | 59.32% | 7.989 s | 2.430x | 58.85%",
            "15.719 s | 17.801 s | 4.499 s | 3.494x | 71.38% | 4.893 s | 3.638x | 72.51% | 3.612 s | 4.352x | 77.02% | 3.445 s | 5.167x | 80.65%",
            "16.037 s | 18.266 s | 3.727 s | 4.303x | 76.76% | 4.341 s | 4.207x | 76.23% | 3.036 s | 5.282x | 81.07% | 2.762 s | 6.612x | 84.88%",
            "16.405 s | 18.395 s | 3.045 s | 5.387x | 81.44% | 3.828 s | 4.805x | 79.19% | 2.751 s | 5.964x | 83.23% | 2.378 s | 7.735x | 87.07%"
        ];
