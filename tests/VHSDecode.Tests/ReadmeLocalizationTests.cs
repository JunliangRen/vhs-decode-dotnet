...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.332 s | 3.510x | 5.067 s | 3.312x | 3.414 s | 4.454x | 3.274 s | 5.125x",
            "17.694 s | 19.414 s | 9.867 s | 1.793x | 11.990 s | 1.619x | 7.163 s | 2.470x | 8.069 s | 2.406x",
            "15.719 s | 17.801 s | 4.268 s | 3.683x | 5.216 s | 3.413x | 3.530 s | 4.453x | 3.203 s | 5.558x",
            "16.037 s | 18.266 s | 3.579 s | 4.481x | 4.328 s | 4.221x | 3.007 s | 5.333x | 2.824 s | 6.469x",
            "16.405 s | 18.395 s | 2.951 s | 5.559x | 3.634 s | 5.062x | 2.618 s | 6.267x | 2.443 s | 7.530x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.332 s | 3.510x | 71.51% | 5.067 s | 3.312x | 69.80% | 3.414 s | 4.454x | 77.55% | 3.274 s | 5.125x | 80.49%",
            "17.694 s | 19.414 s | 9.867 s | 1.793x | 44.24% | 11.990 s | 1.619x | 38.24% | 7.163 s | 2.470x | 59.52% | 8.069 s | 2.406x | 58.44%",
            "15.719 s | 17.801 s | 4.268 s | 3.683x | 72.85% | 5.216 s | 3.413x | 70.70% | 3.530 s | 4.453x | 77.54% | 3.203 s | 5.558x | 82.01%",
            "16.037 s | 18.266 s | 3.579 s | 4.481x | 77.68% | 4.328 s | 4.221x | 76.31% | 3.007 s | 5.333x | 81.25% | 2.824 s | 6.469x | 84.54%",
            "16.405 s | 18.395 s | 2.951 s | 5.559x | 82.01% | 3.634 s | 5.062x | 80.24% | 2.618 s | 6.267x | 84.04% | 2.443 s | 7.530x | 86.72%"
        ];
