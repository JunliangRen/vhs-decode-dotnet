...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "52.811 s | 54.243 s | 12.095 s | 4.366x | 11.445 s | 4.740x | 10.797 s | 4.891x | 9.222 s | 5.882x",
            ...
            "53.555 s | 54.842 s | 7.907 s | 6.773x | 7.499 s | 7.314x | 7.730 s | 6.929x | 5.765 s | 9.513x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "52.811 s | 54.243 s | 12.095 s | 4.366x | 77.10% | 11.445 s | 4.740x | 78.90% | 10.797 s | 4.891x | 79.56% | 9.222 s | 5.882x | 83.00%",
            ...
            "53.555 s | 54.842 s | 7.907 s | 6.773x | 85.24% | 7.499 s | 7.314x | 86.33% | 7.730 s | 6.929x | 85.57% | 5.765 s | 9.513x | 89.49%"
        ];
