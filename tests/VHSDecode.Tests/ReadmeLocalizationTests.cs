...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.332 s | 3.510x | 5.402 s | 3.106x | 3.575 s | 4.254x | 3.558 s | 4.717x",
            "17.694 s | 19.414 s | 9.867 s | 1.793x | 12.596 s | 1.541x | 7.070 s | 2.503x | 8.636 s | 2.248x",
            "15.719 s | 17.801 s | 4.268 s | 3.683x | 5.365 s | 3.318x | 3.521 s | 4.465x | 3.503 s | 5.081x",
            "16.037 s | 18.266 s | 3.579 s | 4.481x | 4.379 s | 4.171x | 3.014 s | 5.321x | 2.886 s | 6.328x",
            "16.405 s | 18.395 s | 2.951 s | 5.559x | 3.885 s | 4.735x | 2.672 s | 6.140x | 2.583 s | 7.123x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.332 s | 3.510x | 71.51% | 5.402 s | 3.106x | 67.81% | 3.575 s | 4.254x | 76.49% | 3.558 s | 4.717x | 78.80%",
            "17.694 s | 19.414 s | 9.867 s | 1.793x | 44.24% | 12.596 s | 1.541x | 35.12% | 7.070 s | 2.503x | 60.04% | 8.636 s | 2.248x | 55.51%",
            "15.719 s | 17.801 s | 4.268 s | 3.683x | 72.85% | 5.365 s | 3.318x | 69.86% | 3.521 s | 4.465x | 77.60% | 3.503 s | 5.081x | 80.32%",
            "16.037 s | 18.266 s | 3.579 s | 4.481x | 77.68% | 4.379 s | 4.171x | 76.02% | 3.014 s | 5.321x | 81.21% | 2.886 s | 6.328x | 84.20%",
            "16.405 s | 18.395 s | 2.951 s | 5.559x | 82.01% | 3.885 s | 4.735x | 78.88% | 2.672 s | 6.140x | 83.71% | 2.583 s | 7.123x | 85.96%"
        ];
