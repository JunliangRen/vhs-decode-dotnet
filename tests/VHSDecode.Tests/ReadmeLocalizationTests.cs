...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.267 s | 3.564x | 4.723 s | 3.553x | 3.608 s | 4.215x | 3.337 s | 5.029x",
            "17.694 s | 19.414 s | 9.732 s | 1.818x | 11.602 s | 1.673x | 7.089 s | 2.496x | 7.845 s | 2.475x",
            "15.719 s | 17.801 s | 4.167 s | 3.772x | 5.026 s | 3.542x | 3.607 s | 4.358x | 3.228 s | 5.515x",
            "16.037 s | 18.266 s | 3.274 s | 4.899x | 3.869 s | 4.721x | 3.069 s | 5.225x | 2.802 s | 6.518x",
            "16.405 s | 18.395 s | 2.919 s | 5.620x | 3.612 s | 5.093x | 2.667 s | 6.150x | 2.262 s | 8.134x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.267 s | 3.564x | 71.94% | 4.723 s | 3.553x | 71.85% | 3.608 s | 4.215x | 76.28% | 3.337 s | 5.029x | 80.12%",
            "17.694 s | 19.414 s | 9.732 s | 1.818x | 45.00% | 11.602 s | 1.673x | 40.24% | 7.089 s | 2.496x | 59.93% | 7.845 s | 2.475x | 59.59%",
            "15.719 s | 17.801 s | 4.167 s | 3.772x | 73.49% | 5.026 s | 3.542x | 71.77% | 3.607 s | 4.358x | 77.05% | 3.228 s | 5.515x | 81.87%",
            "16.037 s | 18.266 s | 3.274 s | 4.899x | 79.59% | 3.869 s | 4.721x | 78.82% | 3.069 s | 5.225x | 80.86% | 2.802 s | 6.518x | 84.66%",
            "16.405 s | 18.395 s | 2.919 s | 5.620x | 82.21% | 3.612 s | 5.093x | 80.36% | 2.667 s | 6.150x | 83.74% | 2.262 s | 8.134x | 87.71%"
        ];
