...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 7.209 s | 2.109x | 7.914 s | 2.120x | 5.388 s | 2.822x | 5.279 s | 3.179x",
            "17.694 s | 19.414 s | 12.109 s | 1.461x | 14.143 s | 1.373x | 8.568 s | 2.065x | 9.757 s | 1.990x",
            "15.719 s | 17.801 s | 7.238 s | 2.172x | 7.651 s | 2.327x | 5.266 s | 2.985x | 5.125 s | 3.473x",
            "16.037 s | 18.266 s | 5.862 s | 2.736x | 6.720 s | 2.718x | 4.967 s | 3.229x | 4.645 s | 3.933x",
            "16.405 s | 18.395 s | 5.779 s | 2.839x | 6.323 s | 2.909x | 4.634 s | 3.540x | 4.361 s | 4.218x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 7.209 s | 2.109x | 52.59% | 7.914 s | 2.120x | 52.84% | 5.388 s | 2.822x | 64.57% | 5.279 s | 3.179x | 68.54%",
            "17.694 s | 19.414 s | 12.109 s | 1.461x | 31.56% | 14.143 s | 1.373x | 27.15% | 8.568 s | 2.065x | 51.58% | 9.757 s | 1.990x | 49.74%",
            "15.719 s | 17.801 s | 7.238 s | 2.172x | 53.95% | 7.651 s | 2.327x | 57.02% | 5.266 s | 2.985x | 66.50% | 5.125 s | 3.473x | 71.21%",
            "16.037 s | 18.266 s | 5.862 s | 2.736x | 63.44% | 6.720 s | 2.718x | 63.21% | 4.967 s | 3.229x | 69.03% | 4.645 s | 3.933x | 74.57%",
            "16.405 s | 18.395 s | 5.779 s | 2.839x | 64.77% | 6.323 s | 2.909x | 65.62% | 4.634 s | 3.540x | 71.75% | 4.361 s | 4.218x | 76.29%"
        ];
