...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.267 s | 3.564x | 5.062 s | 3.315x | 3.608 s | 4.215x | 3.382 s | 4.961x",
            "17.694 s | 19.414 s | 9.732 s | 1.818x | 11.789 s | 1.647x | 7.089 s | 2.496x | 7.978 s | 2.433x",
            "15.719 s | 17.801 s | 4.167 s | 3.772x | 5.058 s | 3.519x | 3.607 s | 4.358x | 3.297 s | 5.399x",
            "16.037 s | 18.266 s | 3.274 s | 4.899x | 4.391 s | 4.160x | 3.069 s | 5.225x | 2.710 s | 6.740x",
            "16.405 s | 18.395 s | 2.919 s | 5.620x | 3.198 s | 5.753x | 2.667 s | 6.150x | 2.189 s | 8.405x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.267 s | 3.564x | 71.94% | 5.062 s | 3.315x | 69.84% | 3.608 s | 4.215x | 76.28% | 3.382 s | 4.961x | 79.84%",
            "17.694 s | 19.414 s | 9.732 s | 1.818x | 45.00% | 11.789 s | 1.647x | 39.28% | 7.089 s | 2.496x | 59.93% | 7.978 s | 2.433x | 58.90%",
            "15.719 s | 17.801 s | 4.167 s | 3.772x | 73.49% | 5.058 s | 3.519x | 71.59% | 3.607 s | 4.358x | 77.05% | 3.297 s | 5.399x | 81.48%",
            "16.037 s | 18.266 s | 3.274 s | 4.899x | 79.59% | 4.391 s | 4.160x | 75.96% | 3.069 s | 5.225x | 80.86% | 2.710 s | 6.740x | 85.16%",
            "16.405 s | 18.395 s | 2.919 s | 5.620x | 82.21% | 3.198 s | 5.753x | 82.62% | 2.667 s | 6.150x | 83.74% | 2.189 s | 8.405x | 88.10%"
        ];
