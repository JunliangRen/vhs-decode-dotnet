...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.332 s | 3.510x | 5.402 s | 3.106x | 3.414 s | 4.454x | 3.285 s | 5.108x",
            "17.694 s | 19.414 s | 9.867 s | 1.793x | 12.596 s | 1.541x | 7.163 s | 2.470x | 8.754 s | 2.218x",
            "15.719 s | 17.801 s | 4.268 s | 3.683x | 5.365 s | 3.318x | 3.530 s | 4.453x | 3.269 s | 5.445x",
            "16.037 s | 18.266 s | 3.579 s | 4.481x | 4.379 s | 4.171x | 3.007 s | 5.333x | 2.896 s | 6.307x",
            "16.405 s | 18.395 s | 2.951 s | 5.559x | 3.885 s | 4.735x | 2.618 s | 6.267x | 2.433 s | 7.559x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.332 s | 3.510x | 71.51% | 5.402 s | 3.106x | 67.81% | 3.414 s | 4.454x | 77.55% | 3.285 s | 5.108x | 80.42%",
            "17.694 s | 19.414 s | 9.867 s | 1.793x | 44.24% | 12.596 s | 1.541x | 35.12% | 7.163 s | 2.470x | 59.52% | 8.754 s | 2.218x | 54.91%",
            "15.719 s | 17.801 s | 4.268 s | 3.683x | 72.85% | 5.365 s | 3.318x | 69.86% | 3.530 s | 4.453x | 77.54% | 3.269 s | 5.445x | 81.63%",
            "16.037 s | 18.266 s | 3.579 s | 4.481x | 77.68% | 4.379 s | 4.171x | 76.02% | 3.007 s | 5.333x | 81.25% | 2.896 s | 6.307x | 84.14%",
            "16.405 s | 18.395 s | 2.951 s | 5.559x | 82.01% | 3.885 s | 4.735x | 78.88% | 2.618 s | 6.267x | 84.04% | 2.433 s | 7.559x | 86.77%"
        ];
