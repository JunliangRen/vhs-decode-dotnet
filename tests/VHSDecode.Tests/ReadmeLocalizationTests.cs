...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 7.533 s | 2.019x | 7.725 s | 2.172x | 5.320 s | 2.858x | 5.171 s | 3.245x",
            "17.694 s | 19.414 s | 12.291 s | 1.440x | 14.181 s | 1.369x | 8.524 s | 2.076x | 9.719 s | 1.997x",
            "15.719 s | 17.801 s | 7.258 s | 2.166x | 7.626 s | 2.334x | 5.299 s | 2.966x | 5.150 s | 3.457x",
            "16.037 s | 18.266 s | 5.901 s | 2.718x | 6.861 s | 2.662x | 4.979 s | 3.221x | 4.702 s | 3.885x",
            "16.405 s | 18.395 s | 5.852 s | 2.803x | 6.058 s | 3.036x | 4.596 s | 3.569x | 4.345 s | 4.234x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 7.533 s | 2.019x | 50.46% | 7.725 s | 2.172x | 53.96% | 5.320 s | 2.858x | 65.01% | 5.171 s | 3.245x | 69.19%",
            "17.694 s | 19.414 s | 12.291 s | 1.440x | 30.53% | 14.181 s | 1.369x | 26.95% | 8.524 s | 2.076x | 51.82% | 9.719 s | 1.997x | 49.94%",
            "15.719 s | 17.801 s | 7.258 s | 2.166x | 53.83% | 7.626 s | 2.334x | 57.16% | 5.299 s | 2.966x | 66.29% | 5.150 s | 3.457x | 71.07%",
            "16.037 s | 18.266 s | 5.901 s | 2.718x | 63.20% | 6.861 s | 2.662x | 62.44% | 4.979 s | 3.221x | 68.95% | 4.702 s | 3.885x | 74.26%",
            "16.405 s | 18.395 s | 5.852 s | 2.803x | 64.33% | 6.058 s | 3.036x | 67.07% | 4.596 s | 3.569x | 71.98% | 4.345 s | 4.234x | 76.38%"
        ];
