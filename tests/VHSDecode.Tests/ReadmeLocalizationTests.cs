...
public sealed partial class ReadmeLocalizationTests
{
    private const string LatestPerformanceRunsMarker =
        ...
        "dotnet-current-date=2026-08-12 sinc-unroll-matrix-runs=90 " +
        ...
        "sinc-unroll-tests=33 sinc-unroll-intrinsic-modes=4 " +
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "52.811 s | 54.243 s | 13.595 s | 3.885x | 12.368 s | 4.386x | 11.754 s | 4.493x | 9.768 s | 5.553x",
            "57.067 s | 56.762 s | 34.582 s | 1.650x | 37.922 s | 1.497x | 25.260 s | 2.259x | 27.644 s | 2.053x",
            "52.920 s | 55.722 s | 13.453 s | 3.934x | 12.366 s | 4.506x | 11.868 s | 4.459x | 9.867 s | 5.647x",
            "52.965 s | 54.949 s | 10.689 s | 4.955x | 9.629 s | 5.707x | 10.178 s | 5.204x | 8.055 s | 6.821x",
            "53.555 s | 54.842 s | 8.654 s | 6.188x | 7.545 s | 7.269x | 8.409 s | 6.369x | 6.257 s | 8.764x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "52.811 s | 54.243 s | 13.595 s | 3.885x | 74.26% | 12.368 s | 4.386x | 77.20% | 11.754 s | 4.493x | 77.74% | 9.768 s | 5.553x | 81.99%",
            "57.067 s | 56.762 s | 34.582 s | 1.650x | 39.40% | 37.922 s | 1.497x | 33.19% | 25.260 s | 2.259x | 55.74% | 27.644 s | 2.053x | 51.30%",
            "52.920 s | 55.722 s | 13.453 s | 3.934x | 74.58% | 12.366 s | 4.506x | 77.81% | 11.868 s | 4.459x | 77.57% | 9.867 s | 5.647x | 82.29%",
            "52.965 s | 54.949 s | 10.689 s | 4.955x | 79.82% | 9.629 s | 5.707x | 82.48% | 10.178 s | 5.204x | 80.78% | 8.055 s | 6.821x | 85.34%",
            "53.555 s | 54.842 s | 8.654 s | 6.188x | 83.84% | 7.545 s | 7.269x | 86.24% | 8.409 s | 6.369x | 84.30% | 6.257 s | 8.764x | 88.59%"
        ];
