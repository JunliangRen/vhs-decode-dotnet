...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.389 s | 3.465x | 7.030 s | 2.387x | 3.609 s | 4.213x | 3.801 s | 4.415x",
            "17.694 s | 19.414 s | 10.065 s | 1.758x | 13.871 s | 1.400x | 7.215 s | 2.453x | 9.527 s | 2.038x",
            "15.719 s | 17.801 s | 4.282 s | 3.671x | 7.428 s | 2.396x | 3.568 s | 4.406x | 3.583 s | 4.968x",
            "16.037 s | 18.266 s | 3.494 s | 4.589x | 6.040 s | 3.024x | 3.098 s | 5.177x | 3.027 s | 6.035x",
            "16.405 s | 18.395 s | 3.235 s | 5.071x | 5.118 s | 3.594x | 2.654 s | 6.182x | 2.545 s | 7.229x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.389 s | 3.465x | 71.14% | 7.030 s | 2.387x | 58.10% | 3.609 s | 4.213x | 76.27% | 3.801 s | 4.415x | 77.35%",
            "17.694 s | 19.414 s | 10.065 s | 1.758x | 43.11% | 13.871 s | 1.400x | 28.55% | 7.215 s | 2.453x | 59.23% | 9.527 s | 2.038x | 50.93%",
            "15.719 s | 17.801 s | 4.282 s | 3.671x | 72.76% | 7.428 s | 2.396x | 58.27% | 3.568 s | 4.406x | 77.30% | 3.583 s | 4.968x | 79.87%",
            "16.037 s | 18.266 s | 3.494 s | 4.589x | 78.21% | 6.040 s | 3.024x | 66.93% | 3.098 s | 5.177x | 80.68% | 3.027 s | 6.035x | 83.43%",
            "16.405 s | 18.395 s | 3.235 s | 5.071x | 80.28% | 5.118 s | 3.594x | 72.18% | 2.654 s | 6.182x | 83.82% | 2.545 s | 7.229x | 86.17%"
        ];
