...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.126 s | 3.686x | 4.980 s | 3.369x | 3.480 s | 4.369x | 3.342 s | 5.021x",
        ...
        [
            "15.207 s | 16.780 s | 4.126 s | 3.686x | 72.87% | 4.980 s | 3.369x | 70.32% | 3.480 s | 4.369x | 77.11% | 3.342 s | 5.021x | 80.08%",
            "17.694 s | 19.414 s | 9.767 s | 1.812x | 44.80% | 11.844 s | 1.639x | 38.99% | 7.104 s | 2.491x | 59.85% | 7.887 s | 2.462x | 59.38%",
            "15.719 s | 17.801 s | 4.221 s | 3.724x | 73.15% | 4.853 s | 3.668x | 72.74% | 3.555 s | 4.422x | 77.38% | 3.437 s | 5.179x | 80.69%",
            "16.037 s | 18.266 s | 3.427 s | 4.680x | 78.63% | 4.242 s | 4.306x | 76.77% | 3.036 s | 5.282x | 81.07% | 2.565 s | 7.121x | 85.96%",
            "16.405 s | 18.395 s | 2.928 s | 5.602x | 82.15% | 3.316 s | 5.548x | 81.97% | 2.601 s | 6.308x | 84.15% | 2.239 s | 8.217x | 87.83%"
        ];
