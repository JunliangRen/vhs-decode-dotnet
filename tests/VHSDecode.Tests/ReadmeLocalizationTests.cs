...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.454 s | 3.414x | 4.960 s | 3.383x | 3.619 s | 4.202x | 3.400 s | 4.936x",
            "17.694 s | 19.414 s | 9.931 s | 1.782x | 11.898 s | 1.632x | 7.198 s | 2.458x | 7.989 s | 2.430x",
            "15.719 s | 17.801 s | 4.499 s | 3.494x | 4.480 s | 3.973x | 3.612 s | 4.352x | 3.190 s | 5.581x",
            "16.037 s | 18.266 s | 3.727 s | 4.303x | 4.013 s | 4.551x | 3.036 s | 5.282x | 2.748 s | 6.646x",
            "16.405 s | 18.395 s | 3.045 s | 5.387x | 3.529 s | 5.212x | 2.751 s | 5.964x | 2.288 s | 8.038x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.454 s | 3.414x | 70.71% | 4.960 s | 3.383x | 70.44% | 3.619 s | 4.202x | 76.20% | 3.400 s | 4.936x | 79.74%",
            "17.694 s | 19.414 s | 9.931 s | 1.782x | 43.87% | 11.898 s | 1.632x | 38.71% | 7.198 s | 2.458x | 59.32% | 7.989 s | 2.430x | 58.85%",
            "15.719 s | 17.801 s | 4.499 s | 3.494x | 71.38% | 4.480 s | 3.973x | 74.83% | 3.612 s | 4.352x | 77.02% | 3.190 s | 5.581x | 82.08%",
            "16.037 s | 18.266 s | 3.727 s | 4.303x | 76.76% | 4.013 s | 4.551x | 78.03% | 3.036 s | 5.282x | 81.07% | 2.748 s | 6.646x | 84.95%",
            "16.405 s | 18.395 s | 3.045 s | 5.387x | 81.44% | 3.529 s | 5.212x | 80.81% | 2.751 s | 5.964x | 83.23% | 2.288 s | 8.038x | 87.56%"
        ];
