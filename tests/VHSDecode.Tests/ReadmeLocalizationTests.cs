...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "52.811 s | 54.243 s | 12.780 s | 4.132x | 12.127 s | 4.473x | 11.240 s | 4.698x | 9.488 s | 5.717x",
            "57.067 s | 56.762 s | 31.677 s | 1.802x | 35.077 s | 1.618x | 22.852 s | 2.497x | 24.790 s | 2.290x",
            "52.920 s | 55.722 s | 12.773 s | 4.143x | 11.726 s | 4.752x | 11.328 s | 4.671x | 9.362 s | 5.952x",
            "52.965 s | 54.949 s | 10.460 s | 5.064x | 9.039 s | 6.079x | 9.658 s | 5.484x | 7.621 s | 7.210x",
            "53.555 s | 54.842 s | 8.421 s | 6.359x | 6.707 s | 8.177x | 8.215 s | 6.519x | 5.967 s | 9.191x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "52.811 s | 54.243 s | 12.780 s | 4.132x | 75.80% | 12.127 s | 4.473x | 77.64% | 11.240 s | 4.698x | 78.72% | 9.488 s | 5.717x | 82.51%",
            "57.067 s | 56.762 s | 31.677 s | 1.802x | 44.49% | 35.077 s | 1.618x | 38.20% | 22.852 s | 2.497x | 59.96% | 24.790 s | 2.290x | 56.33%",
            "52.920 s | 55.722 s | 12.773 s | 4.143x | 75.86% | 11.726 s | 4.752x | 78.96% | 11.328 s | 4.671x | 78.59% | 9.362 s | 5.952x | 83.20%",
            "52.965 s | 54.949 s | 10.460 s | 5.064x | 80.25% | 9.039 s | 6.079x | 83.55% | 9.658 s | 5.484x | 81.77% | 7.621 s | 7.210x | 86.13%",
            "53.555 s | 54.842 s | 8.421 s | 6.359x | 84.28% | 6.707 s | 8.177x | 87.77% | 8.215 s | 6.519x | 84.66% | 5.967 s | 9.191x | 89.12%"
        ];
