...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 6.875 s | 2.212x | 7.800 s | 2.151x | 5.162 s | 2.946x | 5.036 s | 3.332x",
            "17.694 s | 19.414 s | 11.740 s | 1.507x | 13.384 s | 1.451x | 8.386 s | 2.110x | 9.587 s | 2.025x",
            "15.719 s | 17.801 s | 6.846 s | 2.296x | 7.541 s | 2.360x | 5.150 s | 3.052x | 5.144 s | 3.460x",
            "16.037 s | 18.266 s | 5.967 s | 2.687x | 6.787 s | 2.691x | 4.732 s | 3.389x | 4.479 s | 4.078x",
            "16.405 s | 18.395 s | 5.381 s | 3.048x | 6.252 s | 2.942x | 4.450 s | 3.686x | 4.383 s | 4.197x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 6.875 s | 2.212x | 54.79% | 7.800 s | 2.151x | 53.52% | 5.162 s | 2.946x | 66.06% | 5.036 s | 3.332x | 69.99%",
            "17.694 s | 19.414 s | 11.740 s | 1.507x | 33.65% | 13.384 s | 1.451x | 31.06% | 8.386 s | 2.110x | 52.60% | 9.587 s | 2.025x | 50.62%",
            "15.719 s | 17.801 s | 6.846 s | 2.296x | 56.45% | 7.541 s | 2.360x | 57.63% | 5.150 s | 3.052x | 67.23% | 5.144 s | 3.460x | 71.10%",
            "16.037 s | 18.266 s | 5.967 s | 2.687x | 62.79% | 6.787 s | 2.691x | 62.84% | 4.732 s | 3.389x | 70.49% | 4.479 s | 4.078x | 75.48%",
            "16.405 s | 18.395 s | 5.381 s | 3.048x | 67.20% | 6.252 s | 2.942x | 66.01% | 4.450 s | 3.686x | 72.87% | 4.383 s | 4.197x | 76.17%"
        ];
