...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 6.875 s | 2.212x | 7.169 s | 2.341x | 5.162 s | 2.946x | 4.510 s | 3.721x",
            "17.694 s | 19.414 s | 11.740 s | 1.507x | 13.167 s | 1.474x | 8.386 s | 2.110x | 9.188 s | 2.113x",
            "15.719 s | 17.801 s | 6.846 s | 2.296x | 7.129 s | 2.497x | 5.150 s | 3.052x | 4.444 s | 4.006x",
            "16.037 s | 18.266 s | 5.967 s | 2.687x | 6.255 s | 2.920x | 4.732 s | 3.389x | 4.032 s | 4.530x",
            "16.405 s | 18.395 s | 5.381 s | 3.048x | 5.576 s | 3.299x | 4.450 s | 3.686x | 3.609 s | 5.098x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 6.875 s | 2.212x | 54.79% | 7.169 s | 2.341x | 57.28% | 5.162 s | 2.946x | 66.06% | 4.510 s | 3.721x | 73.12%",
            "17.694 s | 19.414 s | 11.740 s | 1.507x | 33.65% | 13.167 s | 1.474x | 32.18% | 8.386 s | 2.110x | 52.60% | 9.188 s | 2.113x | 52.67%",
            "15.719 s | 17.801 s | 6.846 s | 2.296x | 56.45% | 7.129 s | 2.497x | 59.95% | 5.150 s | 3.052x | 67.23% | 4.444 s | 4.006x | 75.04%",
            "16.037 s | 18.266 s | 5.967 s | 2.687x | 62.79% | 6.255 s | 2.920x | 65.76% | 4.732 s | 3.389x | 70.49% | 4.032 s | 4.530x | 77.93%",
            "16.405 s | 18.395 s | 5.381 s | 3.048x | 67.20% | 5.576 s | 3.299x | 69.69% | 4.450 s | 3.686x | 72.87% | 3.609 s | 5.098x | 80.38%"
        ];
