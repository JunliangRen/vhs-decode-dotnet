...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.389 s | 3.465x | 5.322 s | 3.153x | 3.609 s | 4.213x | 4.469 s | 3.755x",
            "17.694 s | 19.414 s | 10.065 s | 1.758x | 13.495 s | 1.439x | 7.215 s | 2.453x | 10.757 s | 1.805x",
            "15.719 s | 17.801 s | 4.282 s | 3.671x | 5.323 s | 3.344x | 3.568 s | 4.406x | 4.282 s | 4.157x",
            "16.037 s | 18.266 s | 3.494 s | 4.589x | 4.553 s | 4.012x | 3.098 s | 5.177x | 4.026 s | 4.537x",
            "16.405 s | 18.395 s | 3.235 s | 5.071x | 4.060 s | 4.531x | 2.654 s | 6.182x | 3.526 s | 5.216x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.389 s | 3.465x | 71.14% | 5.322 s | 3.153x | 68.28% | 3.609 s | 4.213x | 76.27% | 4.469 s | 3.755x | 73.37%",
            "17.694 s | 19.414 s | 10.065 s | 1.758x | 43.11% | 13.495 s | 1.439x | 30.49% | 7.215 s | 2.453x | 59.23% | 10.757 s | 1.805x | 44.59%",
            "15.719 s | 17.801 s | 4.282 s | 3.671x | 72.76% | 5.323 s | 3.344x | 70.10% | 3.568 s | 4.406x | 77.30% | 4.282 s | 4.157x | 75.95%",
            "16.037 s | 18.266 s | 3.494 s | 4.589x | 78.21% | 4.553 s | 4.012x | 75.08% | 3.098 s | 5.177x | 80.68% | 4.026 s | 4.537x | 77.96%",
            "16.405 s | 18.395 s | 3.235 s | 5.071x | 80.28% | 4.060 s | 4.531x | 77.93% | 2.654 s | 6.182x | 83.82% | 3.526 s | 5.216x | 80.83%"
        ];
