...
public sealed partial class ReadmeLocalizationTests
{
    ...
    public void LocalizedReadmesShareCommandsAndReleaseFacts()
    {
        ...
        [
            "15.207 s | 16.780 s | 4.295 s | 3.541x | 4.689 s | 3.579x | 3.532 s | 4.305x | 3.312 s | 5.066x",
            "17.694 s | 19.414 s | 9.798 s | 1.806x | 11.757 s | 1.651x | 7.065 s | 2.504x | 7.997 s | 2.428x",
            "15.719 s | 17.801 s | 4.137 s | 3.799x | 4.711 s | 3.779x | 3.592 s | 4.376x | 3.475 s | 5.122x",
            "16.037 s | 18.266 s | 3.433 s | 4.672x | 4.551 s | 4.013x | 3.013 s | 5.322x | 2.817 s | 6.485x",
            "16.405 s | 18.395 s | 3.091 s | 5.307x | 3.454 s | 5.325x | 2.562 s | 6.404x | 2.229 s | 8.252x"
        ];
        string[] expectedDetailedPerformanceRows =
        [
            "15.207 s | 16.780 s | 4.295 s | 3.541x | 71.76% | 4.689 s | 3.579x | 72.06% | 3.532 s | 4.305x | 76.77% | 3.312 s | 5.066x | 80.26%",
            "17.694 s | 19.414 s | 9.798 s | 1.806x | 44.63% | 11.757 s | 1.651x | 39.44% | 7.065 s | 2.504x | 60.07% | 7.997 s | 2.428x | 58.81%",
            "15.719 s | 17.801 s | 4.137 s | 3.799x | 73.68% | 4.711 s | 3.779x | 73.54% | 3.592 s | 4.376x | 77.15% | 3.475 s | 5.122x | 80.48%",
            "16.037 s | 18.266 s | 3.433 s | 4.672x | 78.59% | 4.551 s | 4.013x | 75.08% | 3.013 s | 5.322x | 81.21% | 2.817 s | 6.485x | 84.58%",
            "16.405 s | 18.395 s | 3.091 s | 5.307x | 81.16% | 3.454 s | 5.325x | 81.22% | 2.562 s | 6.404x | 84.38% | 2.229 s | 8.252x | 87.88%"
        ];
