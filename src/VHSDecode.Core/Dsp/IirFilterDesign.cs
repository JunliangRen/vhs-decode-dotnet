...
public static partial class IirFilterDesign
{
        ...
        bool useComplexAngleDivision = false)
    {
        ...
        if (order == 12)
        {
            return
            [
                new Complex(-0.13052619222005193, 0.9914448613738104),
                new Complex(-0.38268343236508984, 0.9238795325112867),
                new Complex(-0.6087614290087207, 0.7933533402912352),
                new Complex(-0.7933533402912353, 0.6087614290087205),
                new Complex(-0.9238795325112867, 0.3826834323650898),
                new Complex(-0.9914448613738104, 0.13052619222005157),
                new Complex(-0.9914448613738104, -0.13052619222005157),
                new Complex(-0.9238795325112867, -0.3826834323650898),
                new Complex(-0.7933533402912353, -0.6087614290087205),
                new Complex(-0.6087614290087207, -0.7933533402912352),
