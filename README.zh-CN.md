...
- Visual Studio 2026 `.slnx` 包含 **1,092** 项标准 xUnit v3 测试；测试可在
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 默认（5） | 14.481 s | 6.264 s / 2.312x | 8.050 s / 1.799x | 6.162 s / 2.350x | 7.861 s / 1.842x |
...
dotnet test --solution VHSDecodeDotNet.slnx -c Release `
  --no-build --no-restore --minimum-expected-tests 1102
```
