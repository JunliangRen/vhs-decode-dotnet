...
2026-08-20 的本机持续资源矩阵使用源提交 `41bfd92` 的全新构建、同一份真实 40 MSPS PAL 采集、
...
| 预览 IPP 20 MSPS | 30.56（30.48-30.63） | 22.99% / 4.60 核 | 40.09% | 1.40% / 13% | 1.52% / 23% | 3,283 MiB |
...
基线为整机 CPU 5.05%、GPU SM 0%、NVENC 0%、显存 3,103 MiB。CUDA 在完整
40、完整 20 与预览 20 中的源帧吞吐分别为 IPP 的 1.48x、1.33x 与 1.54x。完整方法见
